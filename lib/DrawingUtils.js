...
function drawRenderLayer(ctx, layer) {
    ...
    switch (layer.type) {
        ...
        case 'rect':
            customDrawFunc = drawRectRenderLayer;
            break;
    }
 ...
 * @private
 */
function drawRectRenderLayer(ctx, layer) {
    if (!layer.backgroundColor) {
        return;
    }

    CanvasUtils.drawRect(ctx, layer.frame.x, layer.frame.y, layer.frame.width, layer.frame.height, { backgroundColor: layer.backgroundColor });
}
